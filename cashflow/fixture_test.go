...
var (
	...
	cashflowSeed       = cashflow.CashflowModel{
		Date:      time.Now(),
		IdrAmount: "1000000",
...
var upload cashflow.Uploader = func(filename string, file io.Reader) (string, error) {
	return "", nil
}
...
func TestMain(m *testing.M) {
	...
	cashflowDeps = cashflow.NewDeps(upload, cashflowRepository)
